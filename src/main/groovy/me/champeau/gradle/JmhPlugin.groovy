...
//        final Configuration runtimeConfiguration = Hook.createJmhRuntimeConfiguration(project, extension)
//
...
//        }
//
//        Hook.ensureTasksNotExecutedConcurrently(project)
//
//        def hasShadow = project.plugins.findPlugin('com.github.johnrengelman.shadow') != null
//
//        Hook.createJmhSourceSet(project)
//
//        Hook.registerBuildListener(project, extension)
//
...
//        Hook.createJmhRunBytecodeGeneratorTask(project, jmhGeneratedSourcesDir, extension, jmhGeneratedResourcesDir)
//
//        Hook.createJmhCompileGeneratedClassesTask(project, jmhGeneratedSourcesDir, jmhGeneratedClassesDir, extension)
//
...
//        } else {
//            Hook.createStandardJmhJar(project, extension, metaInfExcludes, jmhGeneratedResourcesDir, jmhGeneratedClassesDir, runtimeConfiguration)
//        }
//
...
//        }
//
//        Hook.configureIDESupport(project)
//    }
//
